...
function comList() {
  ...
  var fselect = window.localStorage.getItem('family') || 0;
  var sselect = window.localStorage.getItem('style')  || 3;
  var ssize = window.localStorage.getItem('size') || 8;
  ...
  this.show = function(conf) {
    if(conf.container=='.notepad-dlg-font .font-family'){
      conf.select=fselect;          
    }else if(conf.container=='.notepad-dlg-font .font-style'){               conf.select=sselect;
    }else if(conf.container=='.notepad-dlg-font .font-size'){
      conf.select=ssize;
    }
    ...
    $list.click(function(e) {
      ...
      if(conf.container=='.notepad-dlg-font .font-family'){
        window.localStorage.setItem('family',cfg.select);
      }else if(conf.container=='.notepad-dlg-font .font-style'){
        window.localStorage.setItem('style',cfg.select);
      }else if(conf.container=='.notepad-dlg-font .font-size'){
        window.localStorage.setItem('size',cfg.select);
      }
    });
